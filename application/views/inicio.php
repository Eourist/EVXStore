<nav class="navbar navbar-expand navbar-dark bg-evx-2 sticky-top evx-usernav" style="height: 35px;">
    <ul class="navbar-nav mr-auto" style="margin-right: -15px;">
        <li class="nav-item usernav-btn">
            <a href="#" class="nav-link"><i class="fas fa-user" style="font-size: 15px;"></i>  Ingresar</a>
        </li>
        <li class="nav-item usernav-btn">
            <a href="#" class="nav-link"><i class="fas fa-user-plus"></i>  Registrarse</a>
        </li>
    </ul>
</nav>
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top" style="padding: 0px;">
    <div class="container-fluid">
        <a class="navbar-brand evx-logo" href="#"><img src="<?php echo base_url();?>/Assets/img/evx-logo.png" alt=""> Evexnod</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarsExample04">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarsExample04">
            <ul class="navbar-nav ml-auto evx-nav-menu" style="margin-right: -15px;">
